...
@Named
@Singleton
class DefaultMainDependencyClassesProvider extends DefaultDependencyClassesProvider
        implements MainDependencyClassesProvider {

    @Inject
    DefaultMainDependencyClassesProvider(DependencyAnalyzer dependencyAnalyzer) {
